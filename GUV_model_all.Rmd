...
#priors for kappa
pr_kappa_all = 
                  prior('normal(3,1)', class = 'Intercept', dpar = 'kappa') +
                  prior('normal(0,1)', class = 'b', dpar = 'kappa')+
                  prior('student_t(3, 0, 0.5)', class = 'sd', dpar = 'kappa')
                  prior('student_t(3, 0, 0.3)', class = 'sd', coef = 'B', dpar = 'kappa')+
                  prior('student_t(3, 0, 0.3)', class = 'sd', coef = 'C', dpar = 'kappa')+
                  prior('student_t(3, 0, 0.3)', class = 'sd', coef = 'BC', dpar = 'kappa')
