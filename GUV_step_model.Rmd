...
for(i in 1:20)#length(id_uv))
{
  arrows(x0 = 0,
         y0 = 0,
         x1 = sin(-abs(mu1_id_devchange[i]))*A1(kappa_id_symm[i]),
         y1 = cos(-abs(mu1_id_devchange[i]))*A1(kappa_id_symm[i]),
         lwd = 0.5,
         length = 0.01,
         col = adjustcolor(col_sd, alpha.f = 50/255)
         )
...
for(i in 1:20)#length(id_uv))
{
  arrows(x0 = 0,
         y0 = 0,
         x1 = sin(abs(mu2_id_devchange[i]))*A1(kappa_id_symm[i]),
         y1 = cos(abs(mu2_id_devchange[i]))*A1(kappa_id_symm[i]),
         lwd = 0.5,
         length = 0.01,
