...
#priors for theta
pr_theta_symm = 
                  prior('lognormal(0,1.0)', class = 'Intercept', dpar = 'theta1', lb = 0) #+
                  # prior('normal(4.0,1.0)', class = 'Intercept', dpar = 'theta1') #+
                  # prior('lognormal(log(0.5), 0.7)', class = 'sd', dpar = 'theta1')
...
pr_mu_devchange = prior('normal(0, pi()/1)', class = 'b', nlpar = 'mu0') +
            ...
            check = FALSE) +
            set_prior("target += lognormal_lpdf(log1p_exp(softkappamu) | log(5), 0.6)", #expect high concentration (low variation) 
...
formula_joint = bf(#modulus may not be necessary, included in lpd function
  ...
  nlf(mu2 ~ mu0 -(modulo_circular(mub + muib1)) ), #secondary mean, population mean plus offset, individual mean, plus additional individual offset
  mu0 ~ 1, #primary mean
