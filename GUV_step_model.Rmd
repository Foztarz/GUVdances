...
formula_change = bf(#modulus may not be necessary, included in lpd function
  ...
  # nlf(mu2 ~ modulo_circular(mu0 + mub + mui)), #secondary mean, population mean plus offset, plus individual mean, plus additional individual offset
  mu0 ~ 1, #primary mean
  mui ~ 0 + ID, # mean angle combines fixed and random effects
  ...
  # theta1 ~ 0 + ID, #for mixture weighting, this is specific to individual
...
pr_theta_change = 
                  ...
                  prior('lognormal(log(2.0), 0.3)', class = 'sd', dpar = 'theta1')
