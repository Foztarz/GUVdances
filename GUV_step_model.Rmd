...
formula_change = bf(#modulus may not be necessary, included in lpd function
  ...
  nlf(mu2 ~ mu0 + mub + mui), #secondary mean, population mean plus offset, plus individual mean, plus additional individual offset
...
#all unimodal priors
pr_devchange = pr_mu_devchange + pr_kappa_devchange+ pr_theta_dechange
```
