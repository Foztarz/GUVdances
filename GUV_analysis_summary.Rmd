...
#the 150m circle intersecting with the nearest corner
#West corner 50.805644, 8.809640
#Nearest corner 50.805565, 8.810290
#Near South edge w/in 150m 50.805258, 8.810424

#nearer
garden_coords = list(left = 
                       c(longitude  = 8.809640,
                         latitude = 50.805644),
                     centre = 
                       c(longitude  = 8.810290,
                         latitude = 50.805565),
                     right = 
                       c(longitude  = 8.810424,
                         latitude = 50.805258)
                     )
...
#let's make this equivalent to the phototaxis hypothesis
# garden_bearing[c(1,3)] = garden_bearing[2] + c(-1,1)*30/2#now both are a 30° arc
...
pr_nophoto = pr_photo +
  # prior(normal(0,2*pi()), class = b,  nlpar = 'mu0', coef = 'Intercept')
...
#                  range = c(-1,1)*pi/4,
#                  parameters = 'fixed_mu0',
#                  effects = 'all',
#                  verbose = FALSE)
# bayestestR::rope(x = modlist$no_sunspot,
#                  range = c(-1,1)*pi/4,
#                  parameters = 'mu0_Intercept',
#                  effects = 'all',
#                  verbose = FALSE)
...
#            alpha = 100/255,
#            x_string = paste0('sin(',
#                              'b_mu0_Intercept+garden_bearing_rad',
#                              ')*',
#                              'A1(softplus(',
#                              'b_kappa_Intercept',
#                              '))'),
