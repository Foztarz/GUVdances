...
It is likely that a plurality of dancers had visited locations in the Marburg Botanic Gardens, perhaps in the centre of the main growing area (50°48'03.3"N 8°48'24.1"E). The hive is at 50°48'22.7"N 8°48'40.8"E. That would give the following bearing:
...
garden_coords = c(longitude  = 8.809010,
                  latitude = 50.802586) #centre
garden_bearing = bearing(hive_coords, garden_coords)
#standard bearing
print(garden_bearing %% 360)

garden_bearing_rad = rad(as.numeric(garden_bearing))
```
...
with(as_draws_df(modlist$phototaxis), 
     arrows(x0 = 0, x1 = 0,
            y0 = 0, 
            y1 = (1/1.5)*A1(softplus(median(b_kappa_Intercept))),
            col = 'orange',
            lwd = 2,
            length = 0.1
            )
...
with(as_draws_df(modlist$no_phototaxis), 
     arrows(x0 = 0,
            x1 = (1/1.5)*A1(softplus(median(b_kappa_Intercept)))*
...
with(as_draws_df(modlist$sunspot), 
     arrows(x0 = 0,
            x1 = (1/1.5)*
              A1(softplus(median(b_kappa_Intercept)))*
