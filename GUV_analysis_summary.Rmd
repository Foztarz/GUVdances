...
#                  range = garden_bearing_rad+c(-1,1)*pi/4,
#                  parameters = 'fmu_Intercept',
#                  effects = 'all',
#                  verbose = FALSE)
dr_modlist = lapply(modlist,
                    as_draws_df)
#for each individual, calculate the likelihood of foragind in the expected region
...
with(as_draws_df(modlist$no_phototaxis), 
     arrows(x0 = 0,
