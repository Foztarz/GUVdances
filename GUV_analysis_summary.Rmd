...
names(pair_diffs_lst) = c('green_hl',
                          ...
                          'uvg_hl',
                          'uvg_l')
#Calculate maximum likelihood distribution
...
```{r Set up functions for mean simulations}
